...
sealed class DnsResolverCompat {
    ...
    private object DnsResolverCompat23 : DnsResolverCompat() {
        ...
        private val unboundedIO by lazy {
            if (PrivChTunnel.getInstance().activityManager.isLowRamDevice) Dispatchers.IO
    ...
    private object DnsResolverCompat29 : DnsResolverCompat(), Executor {
        ...
        private val activeNetwork get() = PrivChTunnel.getInstance().connectivityManager.activeNetwork ?: throw IOException("no network")
