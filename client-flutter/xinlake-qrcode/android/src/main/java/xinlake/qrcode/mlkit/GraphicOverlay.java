...
public class GraphicOverlay extends View {
     ...
     *
     * @param imageWidth  the width of the image sent to ML Kit detectors, must be positive
     * @param imageHeight the height of the image sent to ML Kit detectors, must be positive
