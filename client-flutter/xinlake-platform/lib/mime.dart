...
List<String> extensionFromMime(String mime) {
  final exts = <String>[];

  final mimeMatch = mime.toLowerCase().replaceAll('*', '');
  for (final key in _mimeMaps.keys) {
    final mimeType = _mimeMaps[key];
    if (mimeType != null && mimeType.contains(mimeMatch)) {
      exts.add(key);
    }
  }
  return exts;
...
final _mimeMaps = HashMap<String, String>.from(_mimeTypes);
